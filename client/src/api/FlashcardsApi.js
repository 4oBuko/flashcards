...
export function getUserById(id) {
    const response = sendRequestToApi(null, API_URLS.USER_GET.replace(":id", id), "GET");
    const user = new User(response.id, response.nickname, response.email, response.registrationDate, response.isConfirmed);
    return user;
}
